...
| Test count (exact tracked suite)              | `2935`                                                                                                                                                                                       | `scripts/canonical-receipts.ts`                                                                                                                                                             | `sync-surfaces.ts`      |
...
| `tests/**`                                                                        | 307   | exact gate (2,935 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
