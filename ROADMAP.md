...
- Keep the full gate green at every commit (`bun run check`): 1730 tests, ~1.74M assertions, 95.59% line / 92.74% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
