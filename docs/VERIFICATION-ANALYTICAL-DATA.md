<!-- reviewed: 2026-07-16 | Grok assessment accuracy pass + GATE-REPRO-SELECT | canonical facts: docs/VERIFICATION-ANALYTICAL-DATA.md -->
...
[CLAUDE.md](../CLAUDE.md)). Last reconciled by the Grok assessment full-surface accuracy pass on
**2026-07-16** (GATE-REPRO-SELECT restores Reproduction 4.0; ecology/morph/visual narrative
maximalism with specialist humility; CODE_GROUNDED breadth 3.84 #1/129; GATE-REPRO-SELECT + GATE-DOME-REFUGE).
...
| Test count (exact tracked suite)              | `3313`                                                                                                                                                                    | `scripts/canonical-receipts.ts`                                                                                                                                                            | `sync-surfaces.ts`         |
...
| A-Life 9-axis profile                         | `[4.0, 2.4, 3.4, 3.8, 4.5, 4.6, 4.4, 3.5, 4.0]`; breadth `3.844`; rank `#1/129`; z `+3.220` population / `+3.373` peers; Mahalanobis `8.644`; lead `+0.344`               | `CODE_GROUNDED` + CSV + `docs/reports/assets/alife-codeground.json` (GATE-REPRO-SELECT + GATE-DOME-REFUGE)                                                                                 | generated + `verify:facts` |
| Comprehensive standing synthesis (2026-07-12) | **Historical snapshot** (v0.22.0 / 2861 tests / #1/113). Framing still valid; numbers superseded by this §1 row + CODE_GROUNDED                                           | [COMPREHENSIVE-STANDING report](./reports/2026-07-12-COMPREHENSIVE-STANDING-AND-XENO-ALIFE-POSITION.md) · [HTML](./reports/2026-07-12-COMPREHENSIVE-STANDING-AND-XENO-ALIFE-POSITION.html) | prose (NOT auto-synced)    |
...
### Latest local receipt (Windows, 2026-07-14, Bun 1.3.14)
...
### Dome census + underdocumented live systems (P3 surface)

Live composition root (`src/world.ts`) — not decoration. Public surfaces should list these castes
when describing the product:

| Caste / system      | Scale (desktop)         | One-line                                                                |
| ------------------- | ----------------------- | ----------------------------------------------------------------------- |
| Entities            | ≤10k default / 50k mega | 70p brains · biomass graze · Nash · connectome                          |
| AlienFlora          | 60k                     | edible food field · waste fertilizer · soft contact                     |
| Xenomimics          | ≤1000                   | twin brains · graze · trophic prey · sanctuary refuge                   |
| Shoggoths           | 100                     | predators · UMBRA                                                       |
| Puppeteers          | 100                     | remorph / weather / chaos                                               |
| Titans              | 20                      | PD diplomacy · dual economy · harvest                                   |
| Leviathans          | 4                       | RD stirrers · dome graze                                                |
| Apex SuperCreatures | 5 full minds            | SuperMind + body + evo + hunt                                           |
| Light Archons       | 20                      | mind-field echoes (not full SuperMinds)                                 |
| Alphabet glyphs     | 100                     | visual pantheon                                                         |
| NHI                 | ≤1000                   | GOAP manipulators · semantic gene                                       |
| Big Tree residents  | 250+                    | fruit/leaf ecology · sanctuary governance                               |
| Wingmen             | 100×5                   | assist swarms                                                           |
| Soup / Petri        | 128 / ≤64               | Tsotchke genesis                                                        |
| Mechalogodrom       | 1                       | fusion abomination                                                      |
| Weather             | 6 states                | climate-coupled to flora/entities/xeno                                  |
| Collective fields   | live                    | stigmergy / noosphere / morphic / dark-energy fields (composition-root) |
| Connectome          | live                    | topology-only (no physical tether cosmetics)                            |
| Wilderness          | live                    | non-writeback fauna outside petri catalysis                             |

**Honesty holes that stay (P2):** open-endedness 2.4 · entity sexual genome incomplete · coupling
~0.27 · lab null gap ≈ 0 · 5 full minds vs 20 light-echo · ~30/100 deep faculties · peer maturity
1.5/5 · 5s respawn arcade ecology · indicatorOnly forever.
...
default NHI gene is now a live 109-weight `9→6→7` network whose last four inputs are separately ablatable
...
reconstructs and rejects all 170 historical V1–V4 evaluation/calibration seeds. No confirmatory Phase-B
...
- Performance: three fresh processes × ten batches × seven samples with isolated branch state and
  ...
  `2.8494000000000597 ms` — stable pass.
