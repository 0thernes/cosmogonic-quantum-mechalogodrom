...
[![tests](https://img.shields.io/badge/tests-1900%20passing-brightgreen)](./tests)
...
- **The apex mind closes out at ~20 coupled faculties (V98“V100)** ” a **Lindblad/GKSL open-system
  ...
  60 fps frame)** and CI-gated. **1455 tests green · 0 fail (receipts enforced) · 95.68% line / 92.89% func coverage (measured; CI gate ≥ 90 % line / ≥ 85 % function).**
