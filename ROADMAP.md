...
- Keep the full gate green at every commit (`bun run check`): 1648 tests, ~1.74M assertions, 95.77% line / 92.87% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
