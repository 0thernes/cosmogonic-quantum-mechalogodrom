...
[![tests](https://img.shields.io/badge/tests-2389%20exact-brightgreen)](./tests)
...
- Exact tracked-suite receipt: **2,389 tests / 0 fail**. Portable public coverage floor: **84.64% line / 82.21% func**.
