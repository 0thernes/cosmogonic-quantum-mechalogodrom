...
- Latest Windows-local measurement in this checkout: **3,271 tests / 0 fail · 3,551,782 `expect()` calls**; coverage measured `93.57%` line / `91.56%` func across 365 test files.
...
- **The apex mind closes out at ~20 coupled faculties** — a **Lindblad/GKSL open-system
  ...
  <!-- cqm-sync:local-measurement:start -->
  **Latest Windows-local measurement: 3,271 tests / 0 fail / 3,551,782 assertions at `93.57%` line / `91.56%` func.**
  <!-- cqm-sync:local-measurement:end -->
