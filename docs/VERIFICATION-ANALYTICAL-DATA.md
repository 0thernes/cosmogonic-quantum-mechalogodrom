...
| Test count (exact tracked suite)              | `3271`                                                                                                                                                                                       | `scripts/canonical-receipts.ts`                                                                                                                                                            | `sync-surfaces.ts`      |
...
- `bun run verify:receipts` → **3,271 tests, zero failures** · **365 test files** · **3,551,782**
  `expect()` calls · **93.57% line / 91.56% func** on this Windows checkout.
...
| `tests/**`                                                                        | 366   | exact gate (3,271 cases across 365 test files) + tooling | healthy, 0 disabled, all assert                                                                  |
