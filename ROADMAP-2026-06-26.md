...
- Keep the full gate green at every commit (`bun run check`): 2,319 tests, ~1.69M assertions, 84.35% line / 82.05% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
