...
- Keep the full gate green at every commit (`bun run check`): 1238 tests, ~1.74M assertions, 94.87% line / 91.77% func coverage. Tsotchke fully wired, digital biologics growing in the soup.
