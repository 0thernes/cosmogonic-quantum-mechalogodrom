...
| Test count (exact tracked suite)              | `3168`                                                                                                                                                                                       | `scripts/canonical-receipts.ts`                                                                                                                                                            | `sync-surfaces.ts`      |
...
| `tests/**`                                                                        | 340   | exact gate (3,168 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
