...
| Test count (exact tracked suite)              | `3027`                                                                                                                                                                                       | `scripts/canonical-receipts.ts`                                                                                                                                                            | `sync-surfaces.ts`      |
...
### Latest local receipt (Windows, 2026-07-12, Bun 1.3.14)

<!-- cqm-sync:local-measurement:start -->

- `bun run verify:receipts` → **3,001 tests, zero failures** · **340 test files** · **3,539,785**
  `expect()` calls · **93.39% line / 91.37% func** on this Windows checkout.
...
| `tests/**`                                                                        | 340   | exact gate (3,027 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
