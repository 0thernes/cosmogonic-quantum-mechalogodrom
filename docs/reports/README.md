...
`scripts/canonical-receipts.ts` (v0.21.13 · **2,491-test floor** · **84.64 % / 82.21 %** coverage).
Latest Windows-local receipt observed by the current audit: **2,491 completed cases, zero failures,
2,838,652 expect() calls, 92.85% line coverage, and 90.47% function coverage across 276 test files**.
...
- [CONSOLIDATED-22-FILE-AUDIT-CURRENT-2026-07-07.html](../CONSOLIDATED-22-FILE-AUDIT-CURRENT-2026-07-07.html)
  — browser companion for the current file-trust ledger; Markdown preserved verbatim.
...
- `2026-06-26-ALIFE-COMPARATIVE-AUDIT.md` — retired A-Life comparative
  ...
  [assets/](./assets/).
- `2026-06-17-STATE-OF-THE-ART-COMBINED.md` — retired
...
- `2026-06-20-RESEARCH-BEDROCK.md` — retired snapshot of the 2026 literature the project
...
- `2026-06-21-NHSI-HONESTY-AUDIT.md` — retired verified wired-vs-claimed
  scorecard.
- `2026-06-21-NHSI-MANIFESTO-0THERNES-CORP.md` — retired 0thernes
  Corp NHSI vision.

## Rule

Do not treat old receipt numbers inside dated reports as current claims. Living truth is always
VERIFICATION §1. No forked copies, no archives folder.
