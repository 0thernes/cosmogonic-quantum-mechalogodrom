...
**Canonical receipts (measured post BRUTAL GOD build 2026-06-21):** 2185 tests, 95.23% line / 92.22% func (from `bun scripts/verify-receipts.ts --print`). Enforced by `tests/docs-receipts-law.test.ts` + `bun run check`. All surfaces truth-synced. BRUTAL GOD TIER with full pantheon list (Valkorion to Riddick) + BRUTALISM implemented in petri/godform/world using all Tsotchke. 14/14 scaffolding achieved.
...
| ----------------------- | -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| **100 Faculties**       | 11 strata, coupling > count                  | **100/100 in `FacultiesPantheon`** (incl. QUANTUM*\*, ESHKOL*\_, SPIN\_\_, QGT*\*, NQS*\*, NHSI_COLLECTIVE) — live in `world.driveSuper()`. Brutalist God faculties (VOID/PHOENIX/CHAOS/REALITY/SPIRAL/BRUTAL) wired via godPower.                                                                                                                     | **~90% live / 100% structural**       | `faculties-pantheon.ts`, `world.ts`, `super-mind.ts`, coupling-audit                                       |
| **25 Archon pantheons** | 1 NEO + 4 mid + 20 light                     | **25/25 FULLY IMPLEMENTED + BRUTALISM** (all GODFORMS + brutalGodAspect for Valkorion/Thanos/Broly/Knull/Phoenix/Azathoth/Galactus/Gurren/Mxy/Jaspers/Scarlet/DrM/Joker/Zod etc.). BRUTALISM mode: raw heavy direct power (finesse suppressed, irrep monoliths, extreme curvature/spin disorder, crushing events). Full Tsotchke every project drives. | **100% live + BRUTALISM operational** | `godform.ts`, `brutal-god-releases.ts`, `pantheon.ts`, `world.ts`, `digital-biologics.ts`, `petri-dish.ts` |
...
| **10 emergence angles** (canonical) + extended brutal-god angles | world-as-mind, culture, mortality, BRUTALISM, god-scale | **10/10 canonical** (1–7 petri/lore/etc; 8–10 via EmergenceAnglesController) + brutal extensions (transcendence etc.) for the full god pantheon. Wired in `world.ts`.                                                                                                                                                                                 | **100% tracked / ~90% live canonical**          | `emergence-angles.ts`, `world.ts`, NEO-MIND §10                                                            |
| **Butlin 14/14**        | consciousness indicators                     | **14/14 structural receipts** in code + tests. Functional proxies only — **NOT sentience**. See `masters/PHILOSOPHY.md`.                                                                                                                                                                                                                               | **14/14 structural · ~0 sentience**   | `butlin-indicators.test.ts`, `PATH-TO-14-14-CONSCIOUSNESS-INDICATORS.md`, `super-mind.ts`                  |
