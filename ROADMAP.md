...
- Keep the full gate green at every commit (`bun run check`): 1613 tests, ~1.74M assertions, 95.60% line / 92.67% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
