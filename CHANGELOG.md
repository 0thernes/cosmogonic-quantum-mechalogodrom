...
- **Truth-sync (2026-06-17, fourth pass).** Re-verified gate on Bun 1.3.11; aligned commit baseline to `60478a4` and apex bench to **≈ 285 µs mean / 273 µs median** across `/docs` and both frontier reports.
