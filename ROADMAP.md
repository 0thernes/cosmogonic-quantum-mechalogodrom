...
- Keep the full gate green at every commit (`bun run check`): 1498 tests, ~1.69M assertions, 90.83% line / 87.91% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
