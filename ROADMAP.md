...
- Keep the full gate green at every commit (`bun run check`): 1714 tests, ~1.74M assertions, 95.71% line / 92.70% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
