...
- Keep the full gate green at every commit (`bun run check`): 1434 tests, ~1.74M assertions, 94.46% line / 91.37% func coverage. Tsotchke fully wired, digital biologics growing in the soup.
