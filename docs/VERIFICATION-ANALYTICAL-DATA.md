...
| Test count (exact tracked suite)         | `2566`                                                                                                                                                                                          | `scripts/canonical-receipts.ts`                                                                                    | `sync-surfaces.ts`      |
...
| `tests/**`                                                                        | 281   | exact gate (2,566 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
