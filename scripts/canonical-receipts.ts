 ...
 * floor because the same suite measured 93.17% line / 91.16% function on Windows. Propagated to every public surface and
 ...
 */
export const CANONICAL_TEST_COUNT = 2775;
