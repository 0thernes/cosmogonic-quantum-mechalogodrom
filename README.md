...
[![tests](https://img.shields.io/badge/tests-2162%20passing-brightgreen)](./tests)
...
- **The apex mind closes out at ~20 coupled faculties (V98“V100)** ” a **Lindblad/GKSL open-system
  ...
  60 fps frame)** and CI-gated. **2,162 tests green · 0 fail (receipts enforced) · 95.71% line / 92.69% func coverage (measured; CI gate ≥ 90 % line / ≥ 85 % function).**
