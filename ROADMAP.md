...
- Keep the full gate green at every commit (`bun run check`): 1,514 tests, ~1.69M assertions, 90.80% line / 87.91% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
