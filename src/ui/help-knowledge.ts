...
export const HELP_KB: readonly HelpEntry[] = [
  ...
  },
  {
    ...
    body: 'Tsotchke (Eshkol + all 20+ repos from the corpus) is the paramount non-LLM substrate for digital biologics and different forms of existence/sentience. The Primordial Soup / Petri Dish (primordial-soup.ts + petri-dish.ts + digital-biologics.ts) is the growth engine. Super Creature/Archons are the initial spark ("as if God made primordial inorganic soup"); the soup grows independent biologics onward using Eshkol programs (as heritable "DNA"), AD mutation, GWT ignition, full corpus catalysis. 9+ BiologicForms (eshkol-native, moonlab-tensor, qgt-geom, spin-collective, etc.). "Grow What Thou Wilt." Not chat, not images, not SaaS — real math life in the mechalogodrom. See README, ARCHITECTURE, ERD/ERM/ERP, digital-biologics.ts.',
    see: [
      'README.md',
