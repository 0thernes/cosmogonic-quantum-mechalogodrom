...
**Gate:** 1764 tests · 95.65% line / 92.84% func (canonical synced, receipts enforced).
...
`prettier --check` → `tsc --noEmit` (strict) → `oxlint` → `bun test` (**1,764 tests, 0 fail**) →
...
**bit-reproducible from one seed**, ships through a **full CI/CD gate** (1764 tests, 95.65% line / 92.84% func coverage),
