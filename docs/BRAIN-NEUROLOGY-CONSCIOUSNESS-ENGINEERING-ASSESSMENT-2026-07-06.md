...
| **Test floor (portable)**              | **2,775** pass / **0** fail                                                                                          | `scripts/canonical-receipts.ts`                   |
| **Latest local receipt (Windows)**     | **2,775** completed cases / 0 fail · **307** test files · **3,556,386** `expect()` calls                             | run 2026-07-11                                    |
| **Coverage floor — portable (Ubuntu)** | **84.64%** line / **82.21%** func                                                                                    | `scripts/canonical-receipts.ts` (one-sided floor) |
| **Coverage — local (Windows)**         | **93.17%** line / **91.16%** func                                                                                    | this checkout                                     |
...
| 2   | `docs/reports/README.md:8`                                                            | Canonical-receipts version pointer in prose           | `v0.21.6`     | `v0.21.13 · 2,775-test floor · 84.64% / 82.21%`                                                                    | Point current gate text at `VERIFICATION-ANALYTICAL-DATA.md §1` + `canonical-receipts.ts`; let `bun run sync` propagate it                               | **P1 surface-sync**   |
