...
- Ralph loop: deepen Tsotchke wiring per [TSOTCHKE-INTEGRATION-MAP-2026-06-26.md](./TSOTCHKE-INTEGRATION-MAP-2026-06-26.md); NHSI targets tracked in [NHSI-PROGRESS-DASHBOARD.md](./NHSI-PROGRESS-DASHBOARD.md). Gate GREEN (**1,477 tests**, receipts enforced).
