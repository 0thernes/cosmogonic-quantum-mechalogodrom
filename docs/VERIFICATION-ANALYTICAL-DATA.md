...
| Test count (exact tracked suite)              | `3001`                                                                                                                                                                                       | `scripts/canonical-receipts.ts`                                                                                                                                                             | `sync-surfaces.ts`      |
...
| A-Life 9-axis profile                         | `[4.0, 2.4, 3.3, 3.8, 4.5, 4.5, 4.3, 3.5, 4.0]`; breadth `3.8`; rank `#1/113`; z `+3.044` population / `+3.193` peers                                                                        | `docs/reports/2026-06-26-alife-comparison-matrix.csv`, generated stats/geometry                                                                                                             | generated + prose       |
...
| `tests/**`                                                                        | 340   | exact gate (3,001 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
