...
maximalism with specialist humility; CODE_GROUNDED breadth 3.8 #1/129; GATE-REPRO-SELECT + GATE-DOME-REFUGE).
...
| Test count (exact tracked suite)              | `3324`                                                                                                                                                                    | `scripts/canonical-receipts.ts`                                                                                                                                                            | `sync-surfaces.ts`         |
...
| A-Life 9-axis profile                         | `[4.0, 2.0, 3.4, 3.8, 4.5, 4.6, 4.4, 3.5, 4.0]`; breadth `3.8`; rank `#1/129`; z `+3.147` population / `+3.289` peers; Mahalanobis `8.679`; lead `+0.3`                   | `CODE_GROUNDED` + CSV + `docs/reports/assets/alife-codeground.json` (GATE-REPRO-SELECT + GATE-DOME-REFUGE)                                                                                 | generated + `verify:facts` |
...
**Honesty holes that stay (P2):** open-endedness 2.0 · entity sexual genome incomplete · coupling
