...
| 3   | Test rigor & coverage     | 9.0   | A     | `1,984`-test floor (`2104` measured), `2,912,102` `expect()` calls, `83.95%` line / `81.57%` func; receipts law (`verify-receipts.ts`) makes an unmeasured number unshippable. |
