...
> z `+2.990`, peer z `+3.131`). Batches 21–26 gate-lock and correct this receipt: differential-survival
> GA supports Open-endedness `2.4`; exact Eshkol-AD policy learning plus flora-gradient chemotaxis
> support Cognition/Learning `4.1`. Batch 26 found that the initial nearest-cell sampler made the shipped
...
| **Test floor (portable)**              | **2,530** pass / **0** fail                                                                                          | `scripts/canonical-receipts.ts`                         |
| **Latest local receipt (Windows)**     | **2,521** completed cases / 0 fail · **281** test files · **2,839,000** `expect()` calls                             | run 2026-07-11                                          |
| **Coverage floor — portable (Ubuntu)** | **84.64%** line / **82.21%** func                                                                                    | `scripts/canonical-receipts.ts` (gate floor, ±6 pp tol) |
| **Coverage — local (Windows)**         | **92.85%** line / **90.56%** func                                                                                    | this checkout                                           |
...
| 2   | `docs/reports/README.md:8`                                                            | Canonical-receipts version pointer in prose           | `v0.21.6`     | `v0.21.13 · 2,530-test floor · 84.64% / 82.21%`                                                                    | Point current gate text at `VERIFICATION-ANALYTICAL-DATA.md §1` + `canonical-receipts.ts`; let `bun run sync` propagate it                               | **P1 surface-sync**   |
