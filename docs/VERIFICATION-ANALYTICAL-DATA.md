...
| Test count (exact tracked suite)              | `3224`                                                                                                                                                                                       | `scripts/canonical-receipts.ts`                                                                                                                                                            | `sync-surfaces.ts`      |
...
- `bun run verify:receipts` → **3,224 tests, zero failures** · **361 test files** · **3,545,827**
  `expect()` calls · **93.61% line / 91.61% func** on this Windows checkout.
...
| `tests/**`                                                                        | 362   | exact gate (3,224 cases across 361 test files) + tooling | healthy, 0 disabled, all assert                                                                  |
