...
[![tests](https://img.shields.io/badge/tests-2435%20exact-brightgreen)](./tests)
...
- Exact tracked-suite receipt: **2,435 tests / 0 fail**. Portable public coverage floor: **84.64% line / 82.21% func**.
