...
| Test count (exact tracked suite)         | `2832`                                                                                                                                                      | `scripts/canonical-receipts.ts`                                                                                    | `sync-surfaces.ts`      |
...
| `tests/**`                                                                        | 307   | exact gate (2,832 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
