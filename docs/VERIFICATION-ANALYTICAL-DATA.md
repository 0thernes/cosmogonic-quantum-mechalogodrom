...
| Test count (exact tracked suite)              | `3004`                                                                                                                                                                                       | `scripts/canonical-receipts.ts`                                                                                                                                                             | `sync-surfaces.ts`      |
...
| A-Life 9-axis profile                         | `[4.0, 2.4, 3.3, 3.8, 4.5, 4.6, 4.3, 3.5, 4.0]`; breadth `3.8`; rank `#1/113`; z `+3.062` population / `+3.213` peers                                                                        | `docs/reports/2026-06-26-alife-comparison-matrix.csv`, generated stats/geometry                                                                                                             | generated + prose       |
...
- `bun run verify:receipts` ΓåÆ **3,001 tests, zero failures** ┬╖ **340 test files** ┬╖ **3,539,785**
...
history with the correction logged), version `0.22.0` (matches `package.json` ΓÇö the version SSOT), entity `50,000`, bioforms
...
| `tests/**`                                                                        | 340   | exact gate (3,004 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
