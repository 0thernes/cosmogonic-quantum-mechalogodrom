...
- Keep the full gate green at every commit (`bun run check`): 1689 tests, ~1.74M assertions, 95.73% line / 92.91% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
