...
[![coverage](https://img.shields.io/badge/coverage-95.18%25%20line%20%C2%B7%2092.13%25%20func-success)](./docs/TECHNICAL-SPECIFICATION.md)
...
- **The apex mind closes out at ~20 coupled faculties (V98–V100)** — a **Lindblad/GKSL open-system
  ...
  **8.85 ms** in the focused SuperMind bench; the older sub-millisecond / `<2%` GOAL5 claim is superseded
  until re-proven. **1,477 tests green · 0 fail (receipts enforced) · 95.18% line / 92.13% func coverage (measured; CI gate ≥ 90 % line / ≥ 85 % function).**
