...
**Gate:** 1,984 tests · 84.35% line / 82.05% func (canonical synced via verify-receipts 2026-06-26, receipts law enforced).  
...
**bit-reproducible from one seed**, ships through a **full CI/CD gate** (1,984 tests, 84.35% line / 82.05% func coverage),
