...
**Status (v0.22.0):** FULL DEEP DIVE COMPLETE — Tsotchke local corpus plus GitHub studied; the registry maps 22 external repositories as `8 deep`, `7 wired`, `2 harvest`, `4 fenced`, `1 meta`, with `17/21` non-meta integrated. `OBLITERATUS` is fenced and `classical-contrast` is internal. Petri/soup + brutal god tier live. Gate **3,275 tests · 84.64% / 82.21%** (receipts enforced); latest Windows-local pass may exceed the floor. "Grow What Thou Wilt." Performance targets consolidated into [BENCHMARKS-2026-06-26.md](./BENCHMARKS-2026-06-26.md).
...
- Ralph loop: deepen Tsotchke wiring per [TSOTCHKE-INTEGRATION-MAP-2026-06-26.md](./TSOTCHKE-INTEGRATION-MAP-2026-06-26.md); NHSI targets tracked in [NHSI-PROGRESS-DASHBOARD-2026-06-26.md](./NHSI-PROGRESS-DASHBOARD-2026-06-26.md). Gate GREEN (**3,275 tests**, receipts enforced).
