...
- Keep the full gate green at every commit (`bun run check`): 1644 tests, ~1.74M assertions, 95.11% line / 92.02% func coverage. Tsotchke fully wired, digital biologics growing in the soup.
