...
CI receipts law fix (Linux-portable floor):

- Canonical receipts re-floored to Linux-measured **2,308 tests · 84.64% / 82.21%** so ubuntu CI passes; Windows may measure higher (not a regression per `verify-receipts.ts`).
