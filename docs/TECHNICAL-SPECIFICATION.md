...
**Gate:** 1293 tests · 90.00% line / 85.00% func (canonical synced, receipts enforced).
...
| Test : source ratio                        | 0.40 â†’ **90.00% line / 85.00% func** coverage (`bun test --coverage`) |
...
`bun scripts/build.ts`. Coverage gate: line â‰¥ 0.90, function â‰¥ 0.85 (measured 90.00% line / 85.00% func, `bun test --coverage`).
...
**bit-reproducible from one seed**, ships through a **full CI/CD gate** (1293 tests, 90.00% line / 85.00% func coverage),
