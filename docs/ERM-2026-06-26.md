...
The **conceptual** companion to [ERD-2026-06-26.md](./ERD-2026-06-26.md) (which carries the attribute-level diagrams) and
[ERP-2026-06-26.md](./ERP-2026-06-26.md) (the process/pipeline view). Where the ERD answers _"what fields does an entity
...
1. **One world, one seed.** `PERSISTED_STATE.seed` determines every derived name, gate, and random
   draw; the same seed reconstructs an identical world (see [ERP-2026-06-26.md](./ERP-2026-06-26.md) boot sequence).
...
7. **AUDIT_EVENTs are append-only and bounded** — the ring evicts oldest at 200; entries are
   constant-size (see [ERD-2026-06-26.md](./ERD-2026-06-26.md) storage shape and the server's parse-time truncation).
...
See [ERP-2026-06-26.md](./ERP-2026-06-26.md) for how these relationships are _exercised_ over time (the frame pipeline,
...
See README, ARCHITECTURE-2026-06-26.md, reports/2026-06-20-_, tsotchke-_.ts for details. All local/GH docs match.
