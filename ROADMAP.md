...
- Keep the full gate green at every commit (`bun run check`): 1617 tests, ~1.74M assertions, 95.58% line / 92.69% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
