...
- Keep the full gate green at every commit (`bun run check`): 1544 tests, ~1.74M assertions, 94.64% line / 91.50% func coverage. Tsotchke fully wired, digital biologics growing in the soup.
