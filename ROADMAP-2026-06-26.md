...
- Keep the full gate green at every commit (`bun run check`): 2,308-test canonical floor, 84.64% line / 82.21% func canonical floor, receipts enforced. Tsotchke depth-ledger wiring stays honest (~16 of 20 wired with real downstream effect; fenced repos remain out of the deterministic sim), digital biologics growing in the soup.
