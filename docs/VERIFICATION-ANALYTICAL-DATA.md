...
| Test count (exact tracked suite)         | `2418`                                                               | `scripts/canonical-receipts.ts`                                                                                    | `sync-surfaces.ts`      |
...
- `bun run verify:receipts` → **2,418 tests, zero failures** · **270 test files** · **2,447,564**
...
| `tests/**`                                                                        | 263   | exact gate (2,418 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
