...
**Dated 22-report audit/master pair:** [`CONSOLIDATED-22-MASTER-ASSESSMENT-CURRENT-2026-07-07.md`](./CONSOLIDATED-22-MASTER-ASSESSMENT-CURRENT-2026-07-07.md) and [`CONSOLIDATED-22-FILE-AUDIT-CURRENT-2026-07-07.md`](./CONSOLIDATED-22-FILE-AUDIT-CURRENT-2026-07-07.md) preserve the 2026-07-07 publication synthesis and file-trust ledger. Their receipt numbers are historical. <!-- cqm-sync:local-measurement:start -->Current Windows evidence is `2,521 tests / 0 fail / 2,839,000 expect()` with `92.85%` line / `90.56%` function coverage.<!-- cqm-sync:local-measurement:end --> The separate `84.64% / 82.21%` portable coverage floor lives in [verification data](./VERIFICATION-ANALYTICAL-DATA.md). The pair preserves exact lab/Archon/event handles and does not claim sentience.
