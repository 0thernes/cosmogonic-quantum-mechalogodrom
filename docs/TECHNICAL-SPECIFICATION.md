...
**Gate:** 1753 tests · 95.62% line / 92.79% func (canonical synced, receipts enforced).
...
`prettier --check` → `tsc --noEmit` (strict) → `oxlint` → `bun test` (**1,753 tests, 0 fail**) →
...
**bit-reproducible from one seed**, ships through a **full CI/CD gate** (1753 tests, 95.62% line / 92.79% func coverage),
