...
| ----------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| **100 Faculties**       | 11 strata, coupling > count        | **100 instantiated in `FacultiesPantheon`** (stepped each beat in `world.ts` → aggregate activation = a world/percept bias), of which **~30 are DISTINCT faculties genuinely deep-wired into the apex `think()`** (each reads state AND moves the plan/drives/consciousness); the remaining ~70 are a generic-profile bias bank, plus a brutal god-layer (VOID/PHOENIX/CHAOS/REALITY/SPIRAL) wired via godPower.                              | **~30 deep-wired · 100 instantiated** (2026-07-06 A-Life audit snapshot: breadth 4.44 / z=+4.02 highest in 113-system matrix; code-grounded z=+2.92) | `faculties-pantheon.ts`, `world.ts`, `super-mind.ts`, coupling-audit                                                     |
...
| **Butlin 14/14**        | consciousness indicators           | **8/14 MET + 6/14 PARTIAL** (measured by the 2026-06-21 adversarial code audit, verified `file:line` in `super-mind.ts`). The 8 met are genuinely wired; the 6 partial are real but architecturally thin. Functional INDICATORS only — **NOT sentience** (the hard problem is untouched). 2026-07-06 A-Life audit snapshot reaffirms: ~30 deep-wired faculties, 5+20 Archons, 8/14+6/14, alife breadth 4.44 (z=+4.02; code-grounded z=+2.92). | **8/14 met · 6/14 partial · 0 sentience**                                                                                                            | `butlin-indicators.test.ts`, `VERIFICATION-ANALYTICAL-DATA.md`, `SUPER-CREATURE-RESEARCH-2026-06-26.md`, `super-mind.ts` |
