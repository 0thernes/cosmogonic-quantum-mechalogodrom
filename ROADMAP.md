...
- Keep the full gate green at every commit (`bun run check`): 1650 tests, ~1.74M assertions, 90.00% line / 85.00% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
