...
[![tests](https://img.shields.io/badge/tests-1259%20passing-brightgreen)](./tests)
[![coverage](https://img.shields.io/badge/coverage-94.45%25%20line%20%C2%B7%2091.47%25%20func-success)](./docs/TECHNICAL-SPECIFICATION.md)
...
- **The apex mind closes out at ~20 coupled faculties (V98–V100)** — a **Lindblad/GKSL open-system
  ...
  60 fps frame)** and CI-gated. **1,259 tests green · 0 fail · 94.45 % line / 91.47 % function coverage (measured; CI gate ≥ 90 % line / ≥ 85 % function).**
