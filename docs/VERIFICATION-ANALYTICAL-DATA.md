...
| Test count (exact tracked suite)         | `2804`                                                                                                                                                      | `scripts/canonical-receipts.ts`                                                                                    | `sync-surfaces.ts`      |
...
| `tests/**`                                                                        | 307   | exact gate (2,804 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
