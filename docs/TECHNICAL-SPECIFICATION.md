...
**Gate:** 1705 tests · 95.77% line / 92.87% func (canonical synced, receipts enforced).
...
`prettier --check` → `tsc --noEmit` (strict) → `oxlint` → `bun test` (**1,705 tests, 0 fail**) →
...
**bit-reproducible from one seed**, ships through a **full CI/CD gate** (1705 tests, 95.77% line / 92.87% func coverage),
