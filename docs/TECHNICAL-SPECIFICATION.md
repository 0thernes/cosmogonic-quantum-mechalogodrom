...
**Gate:** 1794 tests · 95.65% line / 92.84% func (canonical synced, receipts enforced).
...
`prettier --check` → `tsc --noEmit` (strict) → `oxlint` → `bun test` (**1,794 tests, 0 fail**) →
...
**bit-reproducible from one seed**, ships through a **full CI/CD gate** (1794 tests, 95.65% line / 92.84% func coverage),
