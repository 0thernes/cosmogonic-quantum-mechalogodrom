...
| Test count (exact tracked suite)              | `3013`                                                                                                                                                                                       | `scripts/canonical-receipts.ts`                                                                                                                                                             | `sync-surfaces.ts`      |
...
| `tests/**`                                                                        | 340   | exact gate (3,013 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
