 ...
 * `class="<FFFD>badge<FFFD>"` once shipped straight to the live site with green CI. This gate closes
...
const NHSI_SURFACES = [
  ...
  // Deployed front-page HTML — shipped "144 faculties" / "15 emergence angles" to the live site
  // because this list never policed it. Now gated like every other public surface.
  'index.html',
  'docs.html',
  'specs.html',
];
