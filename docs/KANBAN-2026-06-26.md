...
- Ralph loop: deepen Tsotchke wiring per [TSOTCHKE-INTEGRATION-MAP-2026-06-26.md](./TSOTCHKE-INTEGRATION-MAP-2026-06-26.md); NHSI targets tracked in [NHSI-PROGRESS-DASHBOARD-2026-06-26.md](./NHSI-PROGRESS-DASHBOARD-2026-06-26.md). Gate GREEN (**2,437 tests**, receipts enforced).
