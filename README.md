...
[![tests](https://img.shields.io/badge/tests-2955%20exact-brightgreen)](./tests)
...
- Exact tracked-suite receipt: **2,955 tests / 0 fail**. Portable public coverage floor: **84.64% line / 82.21% func**.
...
- **The apex mind closes out at ~20 coupled faculties** ΓÇö a **Lindblad/GKSL open-system
  ...
  superseded until re-proven. **2,955 exact tracked tests ┬╖ 0 fail (receipts enforced) ┬╖ 84.64% line / 82.21% func portable coverage floor.**
  <!-- cqm-sync:local-measurement:start -->
...
`[4.0, 2.4, 3.2, 3.8, 4.5, 4.5, 4.3, 3.5, 4.0]`; the table retains the earlier self-score only as a
