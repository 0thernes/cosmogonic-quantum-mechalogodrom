...
All stages must pass. Current baseline: prettier clean · tsc 0 · oxlint 0 · **1,984 tests** ·
`verify:receipts` clean · `sync:check` clean · build 11 artifacts. Individual stages:
