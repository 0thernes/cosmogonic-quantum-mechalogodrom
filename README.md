...
[![coverage](https://img.shields.io/badge/coverage-85.29%25%20line%20%C2%B7%2082.76%25%20func-success)](./docs/TECHNICAL-SPECIFICATION-2026-06-26.md)
...
- **The apex mind closes out at ~20 coupled faculties** — a **Lindblad/GKSL open-system
  ...
  **8.85 ms** in the focused SuperMind bench; the older sub-millisecond / `<2%` GOAL5 claim is superseded
  until re-proven. **1,984 tests green · 0 fail (receipts enforced) · 85.29% line / 82.76% func coverage (measured; CI gate ≥ 90 % line / ≥ 85 % function).**
