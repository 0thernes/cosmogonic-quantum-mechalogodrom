...
| ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------ | ---------------------------- | -------------------------------------------------------------------------------- |
| Full gate not proven after current dirty-tree performance work.        | Fixed in this pass.                                                                  | Closed.                      | `bun run check` passed with 1,984 tests, receipts, sync, facts, lint, and build. |
