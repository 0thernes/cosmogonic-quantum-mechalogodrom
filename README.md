...
[![tests](https://img.shields.io/badge/tests-1762%20passing-brightgreen)](./tests)
...
- **The apex mind closes out at ~20 coupled faculties (V98“V100)** ” a **Lindblad/GKSL open-system
  ...
  60 fps frame)** and CI-gated. **1762 tests green · 0 fail (receipts enforced) · 95.65% line / 92.84% func coverage (measured; CI gate ≥ 90 % line / ≥ 85 % function).**
