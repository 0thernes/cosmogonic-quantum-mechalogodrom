...
> latest Windows-local gate on 2026-07-07 measured **2,380 completed cases · 0 failures ·
> 2,867,137 `expect()` calls**. The portable coverage floor remains the synced canonical
