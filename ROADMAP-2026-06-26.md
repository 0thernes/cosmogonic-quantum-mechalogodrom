...
- Keep the full gate green at every commit (`bun run check`): 1,771 tests, ~1.69M assertions, 91.97% line / 94.85% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
