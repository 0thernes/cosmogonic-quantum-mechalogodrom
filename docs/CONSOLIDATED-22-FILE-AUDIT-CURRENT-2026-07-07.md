...
| A-Life comparative matrix           | `NHSI`, `BRAIN`                             | Include code-grounded breadth `3.8`, population `z=+3.147`, peer `z=+3.289`, and the 129-system comparison as a measured comparative claim requiring citation. The `4.44` self-score is quotable only as a labelled historical baseline.                                                                                                                                                             |
