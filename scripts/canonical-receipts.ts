 ...
 *
 * Measured 2026-06-26 (Bun 1.3.14, cold shell); re-verified 2026-07-05 in the managed Windows shell by
 ...
 */
export const CANONICAL_TEST_COUNT = 2295;
export const CANONICAL_LINE_COV = '84.41';
export const CANONICAL_FUNC_COV = '82.11';
