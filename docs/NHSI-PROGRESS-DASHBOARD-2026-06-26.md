...
**Phase-B development (not a receipt):** the NHI's inherited gene now directly receives the four semantic
lanes through a default 109-weight `9→6→7` network, with actual 58/109/211 tiers and a neural-only
ablation. Separate 54/98/186-parameter predictor-V2 and 27/51/99-parameter ordinary resource-head leaves
are implemented but remain production-ineligible: their disjoint development matrices completed with all
rows retained, and both were rejected by their causal controls (predictor temporal ablation slightly wins;
ordinary neural/semantic/recurrent arms tie while the yoked surrogate wins). NHI still requires a closed-loop
material task; no dependency-closed confirmatory protocol was frozen. See
[ADR 0015](./adr/0015-phase-b-neural-semantic-expansion-2026-07-11.md). None of this changes any score or
consciousness/sentience claim.
...
**Dated 22-report audit/master pair:** [`CONSOLIDATED-22-MASTER-ASSESSMENT-CURRENT-2026-07-07.md`](./CONSOLIDATED-22-MASTER-ASSESSMENT-CURRENT-2026-07-07.md) and [`CONSOLIDATED-22-FILE-AUDIT-CURRENT-2026-07-07.md`](./CONSOLIDATED-22-FILE-AUDIT-CURRENT-2026-07-07.md) preserve the 2026-07-07 publication synthesis and file-trust ledger. Their receipt numbers are historical. <!-- cqm-sync:local-measurement:start -->Current Windows evidence is `2,697 tests / 0 fail / 3,525,807 expect()` with `93.13%` line / `91.10%` function coverage.<!-- cqm-sync:local-measurement:end --> The separate `84.64% / 82.21%` portable coverage floor lives in [verification data](./VERIFICATION-ANALYTICAL-DATA.md). The pair preserves exact lab/Archon/event handles and does not claim sentience.
