 ...
 */
export const CANONICAL_TEST_COUNT = 1170; // total tests Bun reports ("Ran N tests"), incl. the receipts guard
export const CANONICAL_LINE_COV = '97.34';
export const CANONICAL_FUNC_COV = '93.42';
