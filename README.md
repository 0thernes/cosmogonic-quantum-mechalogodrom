...
[![tests](https://img.shields.io/badge/tests-1294%20passing-brightgreen)](./tests)
[![coverage](https://img.shields.io/badge/coverage-94.12%25%20line%20%C2%B7%2090.75%25%20func-success)](./docs/TECHNICAL-SPECIFICATION.md)
...
- **The apex mind closes out at ~20 coupled faculties (V98–V100)** — a **Lindblad/GKSL open-system
  ...
  60 fps frame)** and CI-gated. **1,294 tests green · 0 fail · 94.12 % line / 90.75 % function coverage (measured; CI gate ≥ 90 % line / ≥ 85 % function).**
