...
[![tests](https://img.shields.io/badge/tests-1514%20passing-brightgreen)](./tests)
[![coverage](https://img.shields.io/badge/coverage-90.80%25%20line%20%C2%B7%2087.91%25%20func-success)](./docs/TECHNICAL-SPECIFICATION.md)
...
- **The apex mind closes out at ~20 coupled faculties (V98–V100)** — a **Lindblad/GKSL open-system
  ...
  60 fps frame)** and CI-gated. **1,514 tests green · 0 fail (receipts enforced) · 90.80% line / 87.91% func coverage (measured; CI gate ≥ 90 % line / ≥ 85 % function).**
