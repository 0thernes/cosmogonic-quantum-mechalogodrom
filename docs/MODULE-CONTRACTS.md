...
| src/sim/super-body.ts                                             | BROLY-Ψ                                                    | Wild multi-organ morph (EYES/ARMS etc), god-jewel patch, per-variant + live quantum/reflex/qualia pulses/waves. V64: the skin EVOLVES — evolution aura/tier/hue feed the shader so the surface improves/uniquifies over time. Receives form from godform. |
