...
| A-Life 9-axis profile                    | `[4.0, 2.4, 3.2, 3.8, 4.1, 4.5, 4.3, 3.5, 4.0]`; breadth `3.756`; rank `#1/113`; z `+2.954` population / `+3.090` peers                                                                         | `docs/reports/2026-06-26-alife-comparison-matrix.csv`, generated stats/geometry                                    | generated + prose       |
