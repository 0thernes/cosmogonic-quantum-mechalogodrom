...
| A-Life 9-axis profile                         | `[4.0, 2.4, 3.4, 3.8, 4.5, 4.6, 4.4, 3.5, 4.0]`; breadth `3.844`; rank `#1/129`; z `+3.220` population / `+3.373` peers; Mahalanobis `8.644`; lead `+0.344`               | `CODE_GROUNDED` + CSV + `docs/reports/assets/alife-codeground.json` (GATE-REPRO-SELECT + GATE-DOME-REFUGE)                                                                                 | generated + prose       |
