...
[![tests](https://img.shields.io/badge/tests-1400%20passing-brightgreen)](./tests)
[![coverage](https://img.shields.io/badge/coverage-94.43%25%20line%20%C2%B7%2091.26%25%20func-success)](./docs/TECHNICAL-SPECIFICATION.md)
...
- **The apex mind closes out at ~20 coupled faculties (V98â€“V100)** â€” a **Lindblad/GKSL open-system
  ...
  60 fps frame)** and CI-gated. **1398 tests green · 0 fail (receipts enforced) · 94.61 % line / 91.76 % function coverage (measured; CI gate ≥ 90 % line / ≥ 85 % function).**
