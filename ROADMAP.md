...
- Keep the full gate green at every commit (`bun run check`): 1718 tests, ~1.74M assertions, 95.53% line / 92.63% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
