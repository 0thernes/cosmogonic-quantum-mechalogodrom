...
| **Test floor (portable)**              | **3,027** pass / **0** fail                                                                                          | `scripts/canonical-receipts.ts`                   |
| **Latest local receipt (Windows)**     | **3,001** completed cases / 0 fail · **340** test files · **3,539,785** `expect()` calls                             | run 2026-07-12                                    |
| **Coverage floor — portable (Ubuntu)** | **84.64%** line / **82.21%** func                                                                                    | `scripts/canonical-receipts.ts` (one-sided floor) |
| **Coverage — local (Windows)**         | **93.39%** line / **91.37%** func                                                                                    | this checkout                                     |
...
| 2   | `docs/reports/README.md:8`                                                            | Canonical-receipts version pointer in prose           | `v0.21.6`     | `v0.22.0 · 3,027-test floor · 84.64% / 82.21%`                                                                     | Point current gate text at `VERIFICATION-ANALYTICAL-DATA.md §1` + `canonical-receipts.ts`; let `bun run sync` propagate it                               | **P1 surface-sync**   |
