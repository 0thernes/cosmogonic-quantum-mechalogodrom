<!-- reviewed: 2026-07-10 | causal addendum over historical v0.21.9 assessment | canonical: docs/VERIFICATION-ANALYTICAL-DATA.md -->

# Brain, Neurology, Consciousness & Sentience-Path Engineering Assessment — Master Edition

> **Superseding current-state addendum (2026-07-10).** The body below preserves the v0.21.9
...
> vector is `[4.0, 2.2, 3.2, 3.8, 3.9, 4.5, 4.3, 3.5, 4.0]` (breadth `3.711`, rank `#1/113`, population
> z `+2.881`, peer z `+3.008`). A fresh disjoint fixed-family 30-seed organism-intelligence evaluation
...
> aggregate-mapping specificity. Therefore V3 authorizes no additional brain, A-Life, consciousness, or
> sentience score increase. See the
...
| 3   | `docs/KANBAN-2026-06-26.md:17`                                                        | Tsotchke corpus count                                 | `19` projects | 22 external repos; depth classes 8 deep / 7 wired / 2 harvest / 4 fenced / 1 meta | Rewrite: "registry maps 22 external repos with 17/21 non-meta integrated; OBLITERATUS fenced and classical-contrast internal"; matches `TSOTCHKE-INTEGRATION-MAP` + `tsotchke-registry.ts` | **P2 count-accuracy** |
...
**Section files (this assignment):** the three sections above (§17, §18, §19) preserve the v0.21.9 snapshot. Current Tsotchke truth is `17/21 = 80.95%` non-meta external repositories integrated, with four fences including `OBLITERATUS`; current causal and score claims are governed by the 2026-07-10 addendum. Every claim is **indicatorOnly**.
