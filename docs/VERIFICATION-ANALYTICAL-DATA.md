...
| Test count (exact tracked suite)              | `2902`                                                                                                                                                                                       | `scripts/canonical-receipts.ts`                                                                                                                                                             | `sync-surfaces.ts`      |
...
| `tests/**`                                                                        | 307   | exact gate (2,902 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
