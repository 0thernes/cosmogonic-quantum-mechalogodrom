...
**Gate:** 2,360 tests · 84.41% line / 82.11% func (canonical synced via verify-receipts 2026-06-26, receipts law enforced).
...
| Test : source ratio                     | 0.35 → **84.41% line / 82.11% func** coverage (`bun test --coverage`) |
...
**bit-reproducible from one seed**, ships through a **full CI/CD gate** (2,360 tests, 84.41% line / 82.11% func coverage),
