...
- Keep the full gate green at every commit (`bun run check`): 1,477 tests, ~1.69M assertions, 95.03% line / 92.03% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
