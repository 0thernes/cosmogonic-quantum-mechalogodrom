...
[![tests](https://img.shields.io/badge/tests-1242%20passing-brightgreen)](./tests)
[![coverage](https://img.shields.io/badge/coverage-94.71%25%20line%20%C2%B7%2091.67%25%20func-success)](./docs/TECHNICAL-SPECIFICATION.md)
...
- **The apex mind closes out at ~20 coupled faculties (V98â€“V100)** â€” a **Lindblad/GKSL open-system
  ...
  60 fps frame)** and CI-gated. **1544 tests green · 0 fail (receipts enforced) · 94.71 % line / 91.67 % function coverage (measured; CI gate ≥ 90 % line / ≥ 85 % function).**
