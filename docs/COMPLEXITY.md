...
| PageRank pass                                           | `sim/graph-mind`              | O(i·(V + E)), i = iterations         | every 600th frame, offset 300                                    | Top-20 entities get an emissive floor boost while rank holds; offset 300 never shares a frame with the 240f Louvain pass (offset 120 would, at frame 720 and every 1,200f)                                                                                            |
