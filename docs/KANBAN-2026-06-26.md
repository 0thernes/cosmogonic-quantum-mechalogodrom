...
**Status (v0.20.0):** FULL DEEP DIVE COMPLETE — Tsotchke local corpus (Eshkol COMPLETE spec + all mirrors at `Z:\[Vibe Coded (AI)]\(Tsotchke)`) + GH (22 repos) studied; registry maps all 20 projects (~16 wired, 3 fenced). Petri/soup + brutal god tier live. Gate **1,984 tests · 84.35% / 82.05%** (receipts enforced). Local==GH. "Grow What Thou Wilt." **2026-07-03: Comprehensive performance deep dive vs Gemini 3.1 Pro High recommendations completed; PERFORMANCE-OPTIMIZATION-ROADMAP-2026-07-03.md created (479 lines, 6-phase roadmap).**
...
- Ralph loop: deepen Tsotchke wiring per [TSOTCHKE-INTEGRATION-MAP-2026-06-26.md](./TSOTCHKE-INTEGRATION-MAP-2026-06-26.md); NHSI targets tracked in [NHSI-PROGRESS-DASHBOARD-2026-06-26.md](./NHSI-PROGRESS-DASHBOARD-2026-06-26.md). Gate GREEN (**1,984 tests**, receipts enforced).
...
- **Process model (ERP)** — the frame pipeline & boot/audit sequences: [ERD-2026-06-26.md §ERP](./ERD-2026-06-26.md)
- **Data model (ERD/ERM)** — entities, relationships, cardinalities: [ERD-2026-06-26.md](./ERD-2026-06-26.md)
