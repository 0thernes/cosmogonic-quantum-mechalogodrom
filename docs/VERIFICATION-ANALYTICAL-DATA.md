...
| Test count (exact tracked suite)              | `3005`                                                                                                                                                                                       | `scripts/canonical-receipts.ts`                                                                                                                                                             | `sync-surfaces.ts`      |
...
| `tests/**`                                                                        | 340   | exact gate (3,005 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
