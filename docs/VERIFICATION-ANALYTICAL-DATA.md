...
| Test count (exact tracked suite)              | `3303`                                                                                                                                                                                       | `scripts/canonical-receipts.ts`                                                                                                                                                            | `sync-surfaces.ts`      |
...
| A-Life 9-axis profile                         | `[4.0, 2.4, 3.3, 3.8, 4.5, 4.6, 4.4, 3.5, 4.0]`; breadth `3.83`; rank `#1/129`; z `+3.202` population / `+3.352` peers                                                                       | `docs/reports/2026-06-26-alife-comparison-matrix.csv`, generated stats/geometry                                                                                                            | generated + prose       |
