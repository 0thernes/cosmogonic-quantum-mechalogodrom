...
[![tests](https://img.shields.io/badge/tests-2432%20exact-brightgreen)](./tests)
...
- Exact tracked-suite receipt: **2,432 tests / 0 fail**. Portable public coverage floor: **84.64% line / 82.21% func**.
