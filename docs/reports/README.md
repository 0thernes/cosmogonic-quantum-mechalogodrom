...
`scripts/canonical-receipts.ts` (v0.23.0 · **3,301-test floor** · **84.64 % / 82.21 %** coverage).
...
tests, the measured merged 3,301-test canonical floor, a 117-artifact v0.23.0 production build, and one atomic
