...
**Updated:** 2026-07-10 · Tsotchke: **22 external repositories** (`8 deep`, `7 wired`, `2 harvest`, `4 fenced`, `1 meta`; non-meta integrated fraction `17/21 = 0.8095238095238095`). `classical-contrast` is a live internal control and is not counted as an external repository. The code-grounded A-Life profile remains breadth `3.678`, rank `#1/113`, population z `+2.83`, peer z `+2.95`, and peer maturity `1.5/5`. The [organism-intelligence causal audit](./reports/2026-07-10-OPERATIONAL-ORGANISM-INTELLIGENCE-CAUSAL-AUDIT.md) passed resource-seeking, per-channel causality, exclusion, and cost, but failed its 5% reversal-adaptation primary criterion (`3.9129%`). No numeric capability, consciousness, or sentience uplift is allowed.
...
The separate `classical-contrast` control remains operational without entering those totals. The V2
causal receipt found `17/17` integrated channels behaviorally nonzero and all four fences plus metadata
exactly zero. An optional local Eshkol corpus harvest supplies deterministic `.esk` fingerprints; that
...
| ----------------------- | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| **100 Faculties**       | 11 strata, coupling > count        | **100 instantiated in `FacultiesPantheon`** (stepped each beat in `world.ts` → aggregate activation = a world/percept bias), of which **~30 are DISTINCT faculties genuinely deep-wired into the apex `think()`** (each reads state AND moves the plan/drives/consciousness); the remaining ~70 are a generic-profile bias bank, plus a brutal god-layer (VOID/PHOENIX/CHAOS/REALITY/SPIRAL) wired via godPower. | **~30 deep-wired · 100 instantiated** (current code-grounded 113-system breadth `3.678`, population z `+2.83`) | `faculties-pantheon.ts`, `world.ts`, `super-mind.ts`, coupling-audit                                                     |
