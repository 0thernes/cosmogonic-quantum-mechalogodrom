...
[![tests](https://img.shields.io/badge/tests-1613%20passing-brightgreen)](./tests)
[![coverage](https://img.shields.io/badge/coverage-95.60%25%20line%20%C2%B7%2092.67%25%20func-success)](./docs/TECHNICAL-SPECIFICATION.md)
...
A procedural WebGL cosmic ecosystem â€” morphogenic organisms, Shoggoths,
...
Super Creature / 5 Archons is the framework and the **beginning only** â€” "as if God made primordial inorganic soup". The soup grows independent digital biologics onward. "Grow What Thou Wilt." (Aleister Crowley)
...
> ðŸ“– **New here? Read [THE BOOK](./docs/BOOK.md)** â€” the master index over every doc, an
...
> **0.15.0 (2026-06):** **TSOTCHKE MASTER WIRING + PETRI SENTIENCE EXPANSION** — EVERY repo from tsotchke + Tsotchke-Corporation (Eshkol full consciousness language per COMPLETE spec §17: AD primitive + GWT/ignition + factor-graph + KB + .esk DNA; Moonlab tensors/Clifford; QGT/Berry; spin/Hopfield; libirrep; quake/QGE; ulg; logo; tensorcore; PINN/PIMC + all) FULLY wired as substrate. Petri Dish grows independent digital biologics ("Grow What Thou Wilt"). Super Creature = primordial spark only. Not LLM. All docs/masters/GH/About 100% synced accurate current. â€” every repo and kernel from the Tsotchke corpus (Eshkol as the core non-LLM language for AD, GWT, consciousness primitives; Moonlab tensors, QGTL geometry, spin networks, libirrep symmetry, quantum-quake, PINN/PIMC, ulg, logo-lab, tensorcore + all mirrors) is now wired as substrate into the living system.
...
> Super Creature / Archons (composite minds with ~20 faculties, quantum register, consciousness metrics) is the first complex nucleation â€” the beginning of the framework, not the end. Petri is where independent life grows.
...
- **26 behavioral fields** driving up to 50,000 organisms: classic motion
  ...
  hash (flock), and theory behaviors â€” Nash equilibria (`nash`), wealth
...
- **25 sorting-field algorithms** with behaviorally honest names (BUBBLE
  ...
  per frame â€” each selectable from a picker panel with its own cue tone.
- **100 Shoggoths** (16 on phone) â€” Lorenz-ish drifters with grid-queried
  tendrils that consume organisms and respawn corrupted ones.
- **100 puppet masters** (14 on phone) â€” the 3 named heroes AETHON (chaos),
...
- **Quantum cloud** of 3,500â€“10,000 particles with wavefunction wobble,
  collapse, and respawn; **neural connectome** of up to 2,200â€“8,000 links with
  partial GPU uploads.
- **6 procedural Web Audio songs** + a 100-voice synthesized SFX palette â€” no
...
Seven systems added under [docs/PHILOSOPHY.md](./docs/PHILOSOPHY.md) â€” real
math under every effect, and every system reads from AND writes to another:

- **Quantum register** â€” a pure-TS 5-qubit statevector (no simulator dep;
...
- **Reaction-diffusion ground** â€” a genuine Gray-Scott field (128Â², CPU
  ping-pong) as the ground's emissive map; weather tunes feed/kill/diffusion
  and entity deaths scar the pattern.
- **Graph mind** â€” the connectome mirrored into a
...
- **Constellations + lore** â€” a d3-delaunay Voronoi sky-web over the 24
...
- **Audio analysis** â€” an AnalyserNode tap turns the synthesized music back
...
- **Analytics + omens** â€” rolling-window regression (simple-statistics) puts a
  population trend in the telemetry; z-score anomalies emit lore-named omens
  into the audit trail.
- **Lab artifact** â€” a self-contained seeded p5.js "collapse field" at
...
- **10,000 entities** on the ultra tier through InstancedMesh pools â€” â‰¤80
...
- **10 creature phyla**, lore-named at mint, each a template distribution
  ...
  â€” plus seeded wildcard OUTLIERS with impossible palettes, blended behavior
  pairs and Ã—3 parameter excursions.
- **10 TITANS** â€” colossal non-human intelligences patrolling their phyla's
  ...
  flow through the real energy ledger â€” game theory with consequences.
- **Observatory** â€” four live canvas charts: stacked phylum populations,
  titan wealth polylines with war markers, a 10Ã—10 war-matrix heat grid, and
  rdEnergy/qEntropy/trend timelines.
- **Full-device UI** â€” one responsive overlay grid: desktop columns, phone
  sheet stacks, foldable hinge-safe rails, 43â€³-TV 10-foot mode; touch
  controls v2 (drag joystick + look pad + radial action wheel with an
  apocalypse long-press) with â‰¤30 ms haptics.
- **Pantheon rescore** â€” four new QUANTUM-tier dark songs (VOIDCROWN, BLACK
  MERIDIAN, ELDER ENGINE, LAST THEOREM) around the untouched QUANTUM.

### 0.2.1 â€” the audit wave
...
- **Alien atmosphere** â€” an inverted sky dome with a non-Earth baked gradient
  ...
  quantum entropy.
- **In-scene 3D analytics** â€” a holographic instrument panel floating above the
  ...
  segments.
- **Four-page Observatory** â€” overview, variance (meanÂ±Ïƒ bands, histogram,
  Shannon diversity, qEntropyâ€“trend phase), ecology (per-phylum
...
- **25 sorting fields** (was 20) with batched, _visible_ swaps â€” the active
...
- **Soundtrack raised to the QUANTUM tier** â€” VOIDCROWN, ELDER ENGINE, and LAST
...
- **Ultra tier fills 10,000 entities** via per-frame neighbor-query throttles
  ...
  cadence ladder) â€” calibration history in
  [docs/BENCHMARKS.md](./docs/BENCHMARKS.md).
- **Observatory legibility** â€” every chart gains an in-canvas title band,
  axis ticks, bold strokes, and overlap-free layouts; canvases are taller and
  the panel wider on desktop/TV.
- **Mobile ergonomics** â€” panels become edge-docked slide-out sheets
...
The third user-feedback decree â€” make the world visibly come alive
(`docs/MODULE-CONTRACTS.md` Â§CONTRACTS V7):

- **100 distinct sound effects** (was 8) â€” a procedurally generated, seeded
...
- **A living algorithm picker** â€” every sorting-field row reads in its own
  ...
  all 25) modes.
- **Five render modes** â€” SOLID, WIRE, GHOST (x-ray), NEON (self-glow), CHROME
  (mirror), cycled from the toolbar over both the per-mesh and instanced paths.
- **Cosmological singularities** on the chaos control â€” ENTROPY, BLACK HOLE
...
- **Dramatic weather** â€” STORM gales with deterministic lightning, a âˆ’60 Â°C VOID
  deep freeze, a luminous AURORA, a pale FOG whiteout â€” each unmistakable.
- **SIMULATION N(1) / N(2)** â€” toggle between GENESIS (the shipped cosmos) and
  BREAK FREE (the nightmare: raised chaos floor, a lurid inverted sky, rebranded
  title); persisted across sessions.

### HARDENING (0.8.0)

A professional-grade pass â€” no new cosmology, all rigor:

- **Binary heap + bounded top-K** ([src/math/heap.ts](./src/math/heap.ts)) â€” a
...
- **Security + governance automation** â€” CodeQL (`security-extended`, push/PR +
  weekly), Dependabot, a tagged-release CD workflow, CODEOWNERS, a PR template,
  and bug/feature issue templates.
- **Data-model + process docs** â€” [docs/ERM.md](./docs/ERM.md) (conceptual model
...
- **[docs/500-POINT-INSPECTION.md](./docs/500-POINT-INSPECTION.md)** â€” a standing
...
The world gains minds â€” pre-transformer game / A-Life AI, reproduction across
...
- **Deterministic classical-AI kernel** ([src/sim/ai/brains.ts](./src/sim/ai/brains.ts))
  â€” the pre-2016 toolbox as pure, seeded, allocation-free primitives: utility /
...
- **Digital genome + lineage** ([src/sim/genome.ts](./src/sim/genome.ts),
  [src/sim/lineage.ts](./src/sim/lineage.ts)) â€” a heritable gene vector decoding
...
- **Eight faction archetypes** ([src/sim/factions.ts](./src/sim/factions.ts)) â€”
...
- **Environment artifact field** ([src/sim/artifacts.ts](./src/sim/artifacts.ts))
  â€” persistent relics (a scar per death, a relic per summoned singularity, motes)
...
- **Free-LLM Copilot side-chat** ([src/server/copilot.ts](./src/server/copilot.ts),
  ...
  [src/ui/copilot.ts](./src/ui/copilot.ts)) â€” a read-only AI you chat with about
...
### The Living Era (post-0.9.0 Â· V10â€“V100)

Since 0.9.0 the cosmos has grown continuously â€” ninety-plus increments logged in
...
- **A deeper economy & society (V13â€“V23)** â€” two currencies (AURUM â˜‰ / UMBRA â˜¾)
...
- **Creature cognition (V24â€“V29)** â€” Shoggoths perceive Â· remember Â· flee Â· hunt,
  Puppeteers scheme, the outmatched deceive, and peers bargain, trade & ally â€” a
  pure `creatureDrive` kernel closing the cognitionâ†”economy loop.
- **The native engine (V18, V28)** â€” a C++20 / OpenGL SDF ray-marcher with **Jolt
...
- **The 5 SUPER CREATURES / pantheon (GOAL5, V31â€“V48+)** â€” always-active apex beings (Archons): each a ~10k-param composite + legacy 1.4k spine (total ~37k per), wild bodies. 5 at boot.
...
- **The HUD + cosmos directive (V56â€“V64)** â€” the **CENTER HUD** (six panels â†’ one
  ...
  **NEURAL observatory**, **CHAOS MODE** (a toggled Lorenz quantum storm â€”
...
- **Ominous titans + a unified neural box (V68â€“V77)** â€” the titans reborn as
  **4D freak-geometry** (tesseract cage + aura field that warps world physics);
  ...
  live **swap-variance sparkline**; the bottom-right corner is **re-wireframed** â€”
  ...
  Creature's **NEURAL observatory folds into its own box** â€” one panel, **four tabs**
  ...
  repos.
- **The Tsotchke quantum lineage â€” ported & wired (V82â€“V88)** â€” the simulation
  ...
  ([src/math/eshkol-qrng.ts](./src/math/eshkol-qrng.ts)) â€” an 8-qubit phase-array +
  noise generator with a 16-slot entropy pool and physical-constant mixing cascades
  â€” now draws the mind's Born-rule "thought collapse"; the **Quantum Geometric
  Tensor / Fubiniâ€“Study metric**
  ...
  **Substrate** row (Eshkol H Â· QGT vol/Îº Â· Spinâ†’PLAN %) and covered by closed-form
  unit tests.
- **SUPER CREATURE 1.1 â€” the consciousness-metrics layer (V89)** â€” the apex mind now
  ...
  **Global-Workspace ignition** (GNW â€” Baars/Dehaene: a winner-take-all plan-coalition
  ...
  Î¦ proxy** (IIT â€” Tononi: the participation/coherence ratio of the named module
  ...
  board. The real 2023â€“2026 research grounding â€” the Cogitate IIT-vs-GNW adversarial test
  ([Ferrante et al., 2025, _Nature_](https://doi.org/10.1038/s41586-025-08888-1)),
  organoid "wet computing", active inference and the quantum-cognition program â€” is
  catalogued with citations in
  [docs/SUPER-CREATURE-RESEARCH.md](./docs/SUPER-CREATURE-RESEARCH.md).
- **SUPER CREATURE 1.1 â€” the cognitive-architecture expansion (five theories of mind)** â€” three more real,
  deterministic, unit-tested substrates now run inside the apex mind each beat, alongside the GWT ignition
  and IIT Î¦ above: an **echo-state Reservoir** ([src/sim/reservoir.ts](./src/sim/reservoir.ts)) â€” a 64-node
  ...
  - a novelty signal that sharpens curiosity (the reservoir-computing _algorithm_ behind "wet computing",
    ...
    ([src/sim/active-inference.ts](./src/sim/active-inference.ts)) â€” discrete active inference (Friston's FEP):
    ...
    **expected** free energy G (epistemic curiosity + pragmatic goal-seeking); and a **Metacognitive
    Executive** ([src/sim/metacognition.ts](./src/sim/metacognition.ts)) â€” a Higher-Order layer that folds the
    ...
    dynamics Â· Higher-Order metacognition** â€” five distinct scientific theories of mind, each grounded in
    [docs/SUPER-CREATURE-RESEARCH.md](./docs/SUPER-CREATURE-RESEARCH.md).
- **SUPER CREATURE 1.1 â€” the multi-pillar super-intelligence (v0.11.0, V90â€“V97)** â€” the mind grew from five
  ...
  Criticality** ([src/sim/criticality.ts](./src/sim/criticality.ts)) â€” an edge-of-chaos homeostat driving the
  branching ratio ÏƒÌ‚ â†’ 1 (where cortex computes best); an **Empowerment Drive**
  ([src/sim/empowerment.ts](./src/sim/empowerment.ts)) â€” Blahutâ€“Arimoto channel-capacity I(A;Sâ€²) agency
  hunger; a **Holographic Memory** ([src/sim/holographic-memory.ts](./src/sim/holographic-memory.ts)) â€” a
  MAP-VSA/HRR compositional binding store over bipolar hypervectors (bind Â· bundle Â· cleanup); and a
  **Successor Representation** ([src/sim/successor-representation.ts](./src/sim/successor-representation.ts)) â€”
  ...
  ([src/sim/integrated-information.ts](./src/sim/integrated-information.ts)) â€” the min-cut entanglement at the
  minimum-information partition (real IIT irreducibility, not a proxy); **quantum-coherence resources**
  ([src/math/quantum-coherence.ts](./src/math/quantum-coherence.ts)) â€” the Baumgratzâ€“Cramerâ€“Plenio l1-norm +
  ...
  ([src/math/quantum-natural-gradient.ts](./src/math/quantum-natural-gradient.ts)) â€” the apex circuit now
  _descends_ its own Fubiniâ€“Study geometry ([Stokes et al., 2020](https://doi.org/10.22331/q-2020-05-25-269))
...
- **The apex mind closes out at ~20 coupled faculties (V98â€“V100)** â€” a **Lindblad/GKSL open-system
  ...
  curiosity drive â€” Fujii & Nakajima 2017), **Doya neuromodulation**
  ([src/sim/neuromodulation.ts](./src/sim/neuromodulation.ts)), and the genuine quantum-register **Î¦**
  (real IIT min-cut entanglement) now writing back into cognition â€” closed the inert-Î¦ gap. The
  ...
  60 fps frame)** and CI-gated. **1613 tests green · 0 fail (receipts enforced) · 95.60% line / 92.67% func coverage (measured; CI gate ≥ 90 % line / ≥ 85 % function).**
- **State-of-the-art reports (2026-06-17)** â€” two MIT-PhD-grade, measured, frontier-benchmarked assessments:
  ...
  **[Report II â€” The Super Creature](./docs/reports/2026-06-17-STATE-OF-THE-ART-SUPER-CREATURE.md)** â€”
  ...
  A-Life; a consciousness-marker scorecard (~9â€“10/12 functional markers modeled; phenomenal consciousness
...
[masters/](./masters/) â€” Executor, Architect, Physicist â€” bound by
...
Then visit **http://localhost:3000** â€” plus **http://localhost:3000/docs** for
...
â”œâ”€â”€ index.html           # App shell â€” canvas, panels, toolbar, HTMX audit panel
â”œâ”€â”€ docs.html            # Live Mermaid diagram page (served at /docs)
â”œâ”€â”€ src/
â”‚   â”œâ”€â”€ main.ts          # Browser entry â€” boots world, htmx, resize binding
â”‚   â”œâ”€â”€ world.ts         # Composition root â€” SimContext, frame pipeline, UiActions
...
â”œâ”€â”€ lab/                 # quantum-wildbeyond.html â€” seeded p5.js artifact (served at /lab)
...
- [docs/CONTROLS.md](./docs/CONTROLS.md) â€” every control: mouse, keyboard hotkeys,
  touch, bottom-panel buttons, and the 10 camera views
- [docs/MODULE-CONTRACTS.md](./docs/MODULE-CONTRACTS.md) â€” the binding
...
- [docs/PHILOSOPHY.md](./docs/PHILOSOPHY.md) â€” the Quantum Wildbeyond
  aesthetic constitution (real math under every effect)
- [docs/ARCHITECTURE.md](./docs/ARCHITECTURE.md) â€” module graph, data flow,
...
- Data model trilogy: [docs/ERD.md](./docs/ERD.md) (attribute-level structure)
  ...
  rules + write-back matrix) Â· [docs/ERP.md](./docs/ERP.md) (process view â€”
  boot, frame pipeline, cadence schedule, lifecycles)
- [docs/WIREFRAMES.md](./docs/WIREFRAMES.md) â€” desktop/mobile wireframes,
  type scale, color tokens
- [docs/DESIGN-SYSTEM.md](./docs/DESIGN-SYSTEM.md) â€” design-system audit,
  tokens (incl. the 8-hue tribe palette), component + a11y docs
- [docs/COMPLEXITY.md](./docs/COMPLEXITY.md) â€” per-hot-path big-O budget
- [docs/BENCHMARKS.md](./docs/BENCHMARKS.md) â€” measured mitata results for the
  deterministic core (RNG, scalar math, spatial hash, sort steps, quantum
  gates, reaction-diffusion step)
- [docs/reference/](./docs/reference/math-libs-catalog.md) â€” the imported
...
- [docs/500-POINT-INSPECTION.md](./docs/500-POINT-INSPECTION.md) â€” the standing
  quality audit: 25 sections Ã— 20 checkpoints, each with a verdict and evidence
- **[docs/reports/](./docs/reports/)** â€” the state-of-the-art frontier assessments:
...
- [docs/SUPER-CREATURE-RESEARCH.md](./docs/SUPER-CREATURE-RESEARCH.md) â€” the honest
  citation trail behind every apex-mind faculty (2023â€“2026, live-verified)
- [docs/KANBAN.md](./docs/KANBAN.md) â€” the delivery board (cards across columns
  by epic) Â· [ROADMAP.md](./ROADMAP.md) â€” shipped / now / next horizons
...
**Proprietary â€” All Rights Reserved.** Copyright (c) 2026 0thernes. This work
...
Source-level ported algorithms â€” the **Eshkol** qubit-RNG, the **Moonlab/QGTL**
Quantum-Geometric-Tensor, and the **Tsotchke** spin-glass instinct wired into the
Super Creature's quantum mind â€” are reimplemented in this project's own TypeScript
