/**
 * AD-GRADIENT FORAGER — a base-agent that SENSES a food field by exact reverse-mode automatic
 * differentiation (Eshkol Wengert tape, {@link ../math/eshkol-ad}) and climbs its gradient, instead of
 * wandering. This is the first consumption of the exact AD engine OUTSIDE the coupling-critical apex
 * (`super-mind.ts`) — a genuinely operational cognition primitive for the base population.
 *
