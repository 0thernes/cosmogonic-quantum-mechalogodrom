...
- Keep the full gate green at every commit (`bun run check`): 1637 tests, ~1.74M assertions, 95.63% line / 92.73% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
