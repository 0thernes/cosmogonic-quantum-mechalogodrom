...
| Test count (exact tracked suite)              | `3202`                                                                                                                                                                                       | `scripts/canonical-receipts.ts`                                                                                                                                                            | `sync-surfaces.ts`      |
...
| `tests/**`                                                                        | 340   | exact gate (3,202 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
