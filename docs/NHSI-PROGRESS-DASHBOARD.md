...
| **10 emergence angles** | world-as-mind, culture, mortality… | **10/10** — 1–7 in petri/lore/connectome/world; **8–10 via `EmergenceAnglesController`** wired in `world.ts` (Eshkol evolution, cross-strain, collective aggregation).                                                                                                                                                                                 | **100% tracked / ~90% live**          | `emergence-angles.ts`, `world.ts`, NEO-MIND §10                                                            |
...
Each has full `SuperMind.think()`, distinct Tsotchke bias profile, brutal god power, Eshkol program, body morph, petri strain. All propagate through petri/world with substrate-driven effects. BRUTALISM: raw monolith irrep + unfiltered amplitudes + full Tsotchke corpus catalysis.
