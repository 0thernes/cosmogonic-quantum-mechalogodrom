...
**Gate:** 1701 tests · 95.73% line / 92.91% func (canonical synced, receipts enforced).
...
| Test : source ratio                        | 0.40 → **95.73% line / 92.91% func** coverage (`bun test --coverage`) |
...
**bit-reproducible from one seed**, ships through a **full CI/CD gate** (1701 tests, 95.73% line / 92.91% func coverage),
