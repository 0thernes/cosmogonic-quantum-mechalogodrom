...
| **Butlin 14/14**        | consciousness indicators           | **8/14 MET + 6/14 PARTIAL** (measured by the 2026-06-21 adversarial code audit, verified `file:line` in `super-mind.ts`). The 8 met are genuinely wired; the 6 partial are real but architecturally thin. Functional INDICATORS only — **NOT sentience** (the hard problem is untouched). 2026-06-26 A-Life audit snapshot reaffirms: ~30 deep-wired faculties, 5+20 Archons, 8/14+6/14, alife breadth 4.44 (z=3.01). | **8/14 met · 6/14 partial · 0 sentience**                                                                                   | `butlin-indicators.test.ts`, `reports/2026-06-21-NHSI-HONESTY-AUDIT.md`, `CONSCIOUSNESS-LAB-MASTER-2026-07-03.md`, `super-mind.ts` |
