...
| Test count (exact tracked suite)              | `3010`                                                                                                                                                                                       | `scripts/canonical-receipts.ts`                                                                                                                                                             | `sync-surfaces.ts`      |
...
| `tests/**`                                                                        | 340   | exact gate (3,010 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
