...
| `bun run check`                                                                                                                                                                          |            Pass | Full repo gate passed: format, typecheck, lint, receipts, sync, facts, build, and 2,372 tests.             |
...
| ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------ | ---------------------------- | -------------------------------------------------------------------------------- |
| Full gate not proven after current dirty-tree performance work.        | Fixed in this pass.                                                                  | Closed.                      | `bun run check` passed with 2,372 tests, receipts, sync, facts, lint, and build. |
