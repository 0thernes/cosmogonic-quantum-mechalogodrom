...
`scripts/canonical-receipts.ts` (v0.21.13 · **2,507-test floor** · **84.64 % / 82.21 %** coverage).
Latest Windows-local receipt observed by the current audit: **2,507 completed cases, zero failures,
2,838,975 expect() calls, 92.85% line coverage, and 90.55% function coverage across 281 test files**.
