...
**Date:** 2026-06-16 · **Build:** v0.11.0 · **Commit baseline:** `a8d32b2`
...
> **Reading contract.** Every load-bearing number here is a _receipt_ — read from source or produced by the gate, not from memory. Where a claim is not independently measured it is marked **UNVERIFIED**; where the honest answer is "we cannot tell from here," **UNKNOWN**. The binding framing rule for this project: the code documents every faculty as a _model of_ its theory, **never** _"is conscious."_ Companion: _Report I — The Whole Repository_ (`docs/reports/2026-06-16-STATE-OF-THE-ART-WHOLE-REPO.md`).
...
- **Gate witness:** `bun test` → 1,159 pass / 0 fail / 99 files / 1,738,797 assertions, Bun 1.3.11, this session.
...
- **Companion:** _Report I — The Whole Repository_ (`docs/reports/2026-06-16-STATE-OF-THE-ART-WHOLE-REPO.md`).
