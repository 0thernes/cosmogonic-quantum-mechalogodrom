 ...
 *
 * Measured 2026-06-17 (Bun 1.3.14, cold shell) and verified to match reality by
 ...
 */
export const CANONICAL_TEST_COUNT = 1053; // total tests Bun reports ("Ran N tests"), incl. the receipts guard
export const CANONICAL_LINE_COV = '94.67';
export const CANONICAL_FUNC_COV = '91.29';
