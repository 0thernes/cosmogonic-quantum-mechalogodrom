...
**Status (v0.20.0):** FULL DEEP DIVE COMPLETE — Tsotchke local corpus (Eshkol COMPLETE spec + all mirrors at `Z:\[Vibe Coded (AI)]\(Tsotchke)`) + GH (22 repos) studied; registry maps all 20 projects (~16 wired, 3 fenced). Petri/soup + brutal god tier live. Gate **2,360 tests · 84.41% / 82.11%** (receipts enforced). Local==GH. "Grow What Thou Wilt." Performance targets consolidated into [BENCHMARKS-2026-06-26.md](./BENCHMARKS-2026-06-26.md).
