...
**Where the project stands today (`bun run check` green):** v0.20.0 · 2,372 tests
(published floor) / 0 fail · 91.91 % line / 89.62 % function coverage (canonical receipts). The SuperMind
