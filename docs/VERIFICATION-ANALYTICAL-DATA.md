...
| Test count (floor)  | `2319`                    | `scripts/canonical-receipts.ts`                                                      | `sync-surfaces.ts`      |
...
- `bun test --coverage` → **2,319 pass / 0 fail** · **254 test files** · coverage
  **84.35% line / 82.05% func** (measured; canonical synced floor is **2,319** tests · **84.35% line / 82.05% func**
...
| `tests/**`                                                                        | 252   | gate (2,319 pass) + tooling agent                        | healthy, 0 disabled, all assert                                                                  |
