...
describe('F-TIME — time-dilation steps', () => {
  test('OWNER-FINAL ladder: the classic values, verbatim (the ×50 lives in the mecha god-clock only)', () => {
    // Owner 2026-07-15: "I want the old values." A whole-world ×50 ladder was shipped and reverted;
    // this seals the FINAL contract so it cannot silently drift again.
    expect([...TIME_SCALES]).toEqual([0, 0.1, 0.2, 0.5, 1, 2, 3, 5]);
  });
