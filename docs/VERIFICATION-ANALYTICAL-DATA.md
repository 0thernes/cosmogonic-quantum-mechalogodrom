...
| Test count (exact tracked suite)              | `2955`                                                                                                                                                                                       | `scripts/canonical-receipts.ts`                                                                                                                                                             | `sync-surfaces.ts`      |
...
| `tests/**`                                                                        | 307   | exact gate (2,955 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
