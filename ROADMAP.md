...
- Keep the full gate green at every commit (`bun run check`): 1455 tests, ~1.74M assertions, 95.68% line / 92.89% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
