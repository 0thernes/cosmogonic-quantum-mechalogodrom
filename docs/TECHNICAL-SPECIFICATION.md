...
`prettier --check` → `tsc --noEmit` (strict) → `oxlint` → `bun test` (**1,166 tests, 0 fail**) →
...
**bit-reproducible from one seed**, ships through a **full CI/CD gate** (1,166 tests, 97.38 % line coverage),
