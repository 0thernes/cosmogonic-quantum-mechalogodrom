 ...
 */
export const CANONICAL_TEST_COUNT = 1294; // total tests Bun reports ("Ran N tests"), incl. the receipts guard
export const CANONICAL_LINE_COV = '94.12';
export const CANONICAL_FUNC_COV = '90.75';
