...
- Keep the full gate green at every commit (`bun run check`): 1701 tests, ~1.74M assertions, 95.75% line / 92.96% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
