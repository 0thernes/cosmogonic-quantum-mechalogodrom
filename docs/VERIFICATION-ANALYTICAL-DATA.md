...
| Test count (exact tracked suite)         | `2447`                                                               | `scripts/canonical-receipts.ts`                                                                                    | `sync-surfaces.ts`      |
...
| `tests/**`                                                                        | 263   | exact gate (2,447 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
