...
- Keep the full gate green at every commit (`bun run check`): 1,984 tests, ~1.69M assertions, 91.86% line / 89.06% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
