...
- Keep the full gate green at every commit (`bun run check`): 2,295 tests, ~1.69M assertions, 84.41% line / 82.11% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
