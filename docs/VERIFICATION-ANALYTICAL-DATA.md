...
| Test count (exact tracked suite)         | `2453`                                                               | `scripts/canonical-receipts.ts`                                                                                    | `sync-surfaces.ts`      |
...
| `tests/**`                                                                        | 263   | exact gate (2,453 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
