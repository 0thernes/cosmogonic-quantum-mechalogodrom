...
| Test count (exact tracked suite)              | `3252`                                                                                                                                                                                       | `scripts/canonical-receipts.ts`                                                                                                                                                            | `sync-surfaces.ts`      |
...
| `tests/**`                                                                        | 340   | exact gate (3,252 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
