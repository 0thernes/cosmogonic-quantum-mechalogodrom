...
| Test count (exact tracked suite)              | `2952`                                                                                                                                                                                       | `scripts/canonical-receipts.ts`                                                                                                                                                             | `sync-surfaces.ts`      |
...
| `tests/**`                                                                        | 307   | exact gate (2,952 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
