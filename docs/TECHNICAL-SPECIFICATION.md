...
**Gate:** 2022 tests · 95.71% line / 92.89% func (canonical synced, receipts enforced).  
...
**bit-reproducible from one seed**, ships through a **full CI/CD gate** (2019 tests, 95.68% line / 92.89% func coverage),
