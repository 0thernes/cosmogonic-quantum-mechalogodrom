...
= found, not yet implemented (the build queue). Companion to `docs/reports/README.md`,
`docs/SUPER-CREATURE-RESEARCH-2026-06-26.md`, and
`docs/NHSI-PROGRESS-DASHBOARD-2026-06-26.md`. No consciousness/sentience is claimed — these operationalize functional
