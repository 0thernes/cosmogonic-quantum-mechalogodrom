...
| Test count (exact tracked suite)              | `3023`                                                                                                                                                                                       | `scripts/canonical-receipts.ts`                                                                                                                                                             | `sync-surfaces.ts`      |
...
| `tests/**`                                                                        | 340   | exact gate (3,023 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
