...
- Keep the full gate green at every commit (`bun run check`): 2,857 exact tracked tests, 84.64% line / 82.21% func portable coverage floor, receipts enforced. Tsotchke depth-ledger wiring stays honest (`8 deep`, `7 wired`, `2 harvest`, `4 fenced`, `1 meta`; `17/21` non-meta integrated; the four fences include `OBLITERATUS` and remain out of the deterministic sim), digital biologics growing in the soup.
