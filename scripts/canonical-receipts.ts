 ...
 * floor because the same suite measured 93.13% line / 91.10% function on Windows. Propagated to every public surface and
 ...
 */
export const CANONICAL_TEST_COUNT = 2697;
