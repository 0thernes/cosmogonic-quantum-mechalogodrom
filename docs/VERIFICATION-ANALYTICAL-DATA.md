...
| Test count (exact tracked suite)         | `2861`                                                                                                                                                      | `scripts/canonical-receipts.ts`                                                                                    | `sync-surfaces.ts`      |
...
| `tests/**`                                                                        | 307   | exact gate (2,861 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
