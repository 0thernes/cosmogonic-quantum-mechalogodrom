...
- Keep the full gate green at every commit (`bun run check`): 2,372 tests, ~1.69M assertions, 91.91% line / 89.62% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
