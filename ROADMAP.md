...
- Keep the full gate green at every commit (`bun run check`): 1748 tests, ~1.74M assertions, 95.62% line / 92.79% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
