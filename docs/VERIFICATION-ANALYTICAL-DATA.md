...
| Test count (exact tracked suite)              | `2875`                                                                                                                                                                                       | `scripts/canonical-receipts.ts`                                                                                                                                                             | `sync-surfaces.ts`      |
...
| `tests/**`                                                                        | 307   | exact gate (2,875 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
