...
**Non Human Super Intelligence (NHSI)** · Cosmogonic Quantum Mechalogodrom · **v0.17.1 — BRUTAL GOD TIER (Valkorion / Broly / Knull / Phoenix / Gurren Lagann / EVA / Azathoth / Galactus)**  
...
**Updated:** 2026-06-21 (full run of entire repo + build of god powers) · Tsotchke: **ALL 22+ subs** (every repo/project/mirror from tsotchke + Tsotchke-Corp + 12k+ local files, 1436+ .esk + NQS/skyrmion/anyons/flow/thermo etc from audits). **EVERY** wired/catalyzed. Eshkol as will of gods. Tech REAL.
...
**Honest depth ledger:** [`TSOTCHKE-INTEGRATION-MAP.md`](./TSOTCHKE-INTEGRATION-MAP.md) (authoritative over README badge language).
...
| ----------------------- | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| **100 Faculties**       | 11 strata, coupling > count        | **100 instantiated in `FacultiesPantheon`** (stepped each beat in `world.ts` → aggregate activation = a world/percept bias), of which **~30 are DISTINCT faculties genuinely deep-wired into the apex `think()`** (each reads state AND moves the plan/drives/consciousness); the remaining ~70 are a generic-profile bias bank, plus a brutal god-layer (VOID/PHOENIX/CHAOS/REALITY/SPIRAL) wired via godPower. | **~30 deep-wired · 100 instantiated**     | `faculties-pantheon.ts`, `world.ts`, `super-mind.ts`, coupling-audit                                                                  |
...
| **Butlin 14/14**        | consciousness indicators           | **8/14 MET + 6/14 PARTIAL** (measured by the 2026-06-21 adversarial code audit, verified `file:line` in `super-mind.ts`). The 8 met are genuinely wired; the 6 partial are real but architecturally thin. Functional INDICATORS only — **NOT sentience** (the hard problem is untouched).                                                                                                                        | **8/14 met · 6/14 partial · 0 sentience** | `butlin-indicators.test.ts`, `reports/2026-06-21-NHSI-HONESTY-AUDIT.md`, `PATH-TO-14-14-CONSCIOUSNESS-INDICATORS.md`, `super-mind.ts` |
...
| ERD / ERM / ERP    | `docs/ERD.md`, `ERM.md`, `ERP.md`                                    |
