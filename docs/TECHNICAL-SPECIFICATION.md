...
**Gate:** 2,167 tests · 95.73% line / 92.69% func (canonical synced via verify-receipts 2026-06-21, receipts law enforced).  
...
`prettier --check` → `tsc --noEmit` (strict) → `oxlint` → `bun test` (**2,167 tests, 0 fail**) →
...
**bit-reproducible from one seed**, ships through a **full CI/CD gate** (2,167 tests, 95.73% line / 92.69% func coverage),
