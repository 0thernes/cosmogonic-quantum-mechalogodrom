...
- Keep the full gate green at every commit (`bun run check`): 1,984 tests, ~1.69M assertions, 83.95% line / 81.57% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
...
[docs/VENTURES-2026-06-26.md](./docs/VENTURES-2026-06-26.md) (waitlist, hosted multiplayer,
subscriptions) are an **aspirational horizon** that wraps the dome without changing determinism.

## Horizon: Ventures

See [VENTURES-2026-06-26.md](./docs/VENTURES-2026-06-26.md) for the full product roadmap:
