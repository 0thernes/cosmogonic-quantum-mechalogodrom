...
| Test count (exact tracked suite)              | `3167`                                                                                                                                                                                       | `scripts/canonical-receipts.ts`                                                                                                                                                            | `sync-surfaces.ts`      |
...
| `tests/**`                                                                        | 340   | exact gate (3,167 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
