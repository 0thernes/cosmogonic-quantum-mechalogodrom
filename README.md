...
[![tests](https://img.shields.io/badge/tests-3271%20exact-brightgreen)](./tests)
...
- Exact tracked-suite receipt: **3,271 tests / 0 fail**. Portable public coverage floor: **84.64% line / 82.21% func**.
...
- Latest Windows-local measurement in this checkout: **3,224 tests / 0 fail · 3,545,827 `expect()` calls**; coverage measured `93.61%` line / `91.61%` func across 361 test files.
...
- **The apex mind closes out at ~20 coupled faculties** — a **Lindblad/GKSL open-system
  ...
  superseded until re-proven. **3,271 exact tracked tests · 0 fail (receipts enforced) · 84.64% line / 82.21% func portable coverage floor.**
  <!-- cqm-sync:local-measurement:start -->
  **Latest Windows-local measurement: 3,224 tests / 0 fail / 3,545,827 assertions at `93.61%` line / `91.61%` func.**
  <!-- cqm-sync:local-measurement:end -->
