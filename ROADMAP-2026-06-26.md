...
- Keep the full gate green at every commit (`bun run check`): 2,360-test canonical floor, 84.64% line / 82.21% func canonical floor, receipts enforced. Tsotchke depth-ledger wiring stays honest (`9 deep`, `7 wired`, `2 harvest`, `3 fenced`, `1 meta`; scientific wired fraction `18/21`; fenced repos remain out of the deterministic sim), digital biologics growing in the soup.
