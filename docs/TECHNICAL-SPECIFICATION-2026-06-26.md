...
**Gate:** 1,984 tests · 83.95% line / 81.57% func (canonical synced via verify-receipts 2026-06-26, receipts law enforced).  
...
| Test : source ratio                     | 0.34 → **83.95% line / 81.57% func** coverage (`bun test --coverage`) |
...
`bun scripts/build.ts`. Coverage gate: line ≥ 0.90, function ≥ 0.85 (measured 83.95% line / 81.57% func, `bun test --coverage`).
...
**bit-reproducible from one seed**, ships through a **full CI/CD gate** (1,984 tests, 83.95% line / 81.57% func coverage),
