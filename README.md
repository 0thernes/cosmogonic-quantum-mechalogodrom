...
[![coverage](https://img.shields.io/badge/coverage-94.24%25%20line%20%C2%B7%2091.11%25%20func-success)](./docs/TECHNICAL-SPECIFICATION.md)
...
- **The apex mind closes out at ~20 coupled faculties (V98–V100)** — a **Lindblad/GKSL open-system
  ...
  60 fps frame)** and CI-gated. **1,314 tests green · 0 fail · 94.24 % line / 91.11 % function coverage (measured; CI gate ≥ 90 % line / ≥ 85 % function).**
