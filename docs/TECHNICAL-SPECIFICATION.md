...
**Gate:** 1689 tests · 95.73% line / 92.91% func (canonical synced, receipts enforced).
...
**bit-reproducible from one seed**, ships through a **full CI/CD gate** (1689 tests, 95.73% line / 92.91% func coverage),
