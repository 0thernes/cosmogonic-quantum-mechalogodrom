...
| Test count (exact tracked suite)              | `2976`                                                                                                                                                                                       | `scripts/canonical-receipts.ts`                                                                                                                                                             | `sync-surfaces.ts`      |
...
| `tests/**`                                                                        | 307   | exact gate (2,976 tests) + tooling agent                 | healthy, 0 disabled, all assert                                                                  |
