...
- 🟧 P1 `SUPER-EVOLVE` — self-evolving growth (Vegeta/Goku power curve), appearance change over time, an evolutionary history log; a 24h daemon-cron tick that mutates/levels the creatures.
