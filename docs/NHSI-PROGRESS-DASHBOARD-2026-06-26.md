...
| ----------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| **100 Faculties**       | 11 strata, coupling > count        | **100 instantiated in `FacultiesPantheon`** (stepped each beat in `world.ts` → aggregate activation = a world/percept bias), of which **~30 are DISTINCT faculties genuinely deep-wired into the apex `think()`** (each reads state AND moves the plan/drives/consciousness); the remaining ~70 are a generic-profile bias bank, plus a brutal god-layer (VOID/PHOENIX/CHAOS/REALITY/SPIRAL) wired via godPower.      | **~30 deep-wired · 100 instantiated** (2026-06-26 A-Life audit snapshot: breadth 4.44 / z=3.01 highest in 25-system matrix) | `faculties-pantheon.ts`, `world.ts`, `super-mind.ts`, coupling-audit                                             |
...
| **10 emergence angles** | world-as-mind, culture, mortality… | **10/10 wired** — 1–7 petri/lore/connectome; 8–10 via `EmergenceAnglesController` (Eshkol evolution, cross-strain, collective aggregation). Plus 5 god-scale RELEASE EVENTS (warfare, fracture, chaos, harvest, transcendence) — events, not additional emergence angles.                                                                                                                                             | **10/10 wired (+5 god events)**                                                                                             | `emergence-angles.ts`, `world.ts`, [ARCHITECTURE](./ARCHITECTURE-2026-06-26.md) §emergence                       |
| **Butlin 14/14**        | consciousness indicators           | **8/14 MET + 6/14 PARTIAL** (measured by the 2026-06-21 adversarial code audit, verified `file:line` in `super-mind.ts`). The 8 met are genuinely wired; the 6 partial are real but architecturally thin. Functional INDICATORS only — **NOT sentience** (the hard problem is untouched). 2026-06-26 A-Life audit snapshot reaffirms: ~30 deep-wired faculties, 5+20 Archons, 8/14+6/14, alife breadth 4.44 (z=3.01). | **8/14 met · 6/14 partial · 0 sentience**                                                                                   | `butlin-indicators.test.ts`, [SUPER-CREATURE-RESEARCH](./SUPER-CREATURE-RESEARCH-2026-06-26.md), `super-mind.ts` |
...
| NHSI vision        | this dashboard + [PHILOSOPHY](./PHILOSOPHY-2026-06-26.md)                                                                         |
| Research trail     | [SUPER-CREATURE-RESEARCH](./SUPER-CREATURE-RESEARCH-2026-06-26.md) · [papers ledger](./NHSI-RESEARCH-PAPERS-LEDGER-2026-06-26.md) |
| Master XMLs        | `masters/` (Broly · Starkiller · Manhattan)                                                                                       |
| Agent steering     | `CLAUDE.md`                                                                                                                       |
