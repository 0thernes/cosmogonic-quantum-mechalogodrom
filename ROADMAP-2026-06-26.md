...
- Keep the full gate green at every commit (`bun run check`): 1,984 tests, ~1.69M assertions, 85.29% line / 82.76% func coverage (canonical, receipts enforced). Tsotchke fully wired, digital biologics growing in the soup.
